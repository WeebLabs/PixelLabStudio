...
cp "$PROJECT_ROOT/ui_scenes/selectedSprite/sprite_hierarchy.gd" "$TEST_WORKSPACE/ui_scenes/selectedSprite/"
...
mkdir -p "$TEST_WORKSPACE/addons/godot-streamdeck-addon"
cp "$PROJECT_ROOT/addons/godot-streamdeck-addon/protocol.gd" "$TEST_WORKSPACE/addons/godot-streamdeck-addon/"
mkdir -p "$TEST_WORKSPACE/ndi"
cp "$PROJECT_ROOT/ndi/ndi_output_geometry.gd" "$TEST_WORKSPACE/ndi/"
